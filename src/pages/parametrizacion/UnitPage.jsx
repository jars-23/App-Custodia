...
import UnitModal from "../modals/parametrizacion/UnitModal";
...
const UnitPage = () => {
    ...
    const getUnit = () => {
        ...
        fetch(`${BACKEND_URL}Administracion/TipoUnidadObtener`, {
            method: 'POST',
            headers: {
    ...
    const handleEdit = (rowData) => {
        setTitle("Editar unidad de conservación");
    ...
    const openModals = () => {
        setTitle("Agregar nueva unidad de conservación");
        setSelectedRow([]);
        setOpenModal(true);
      };
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Unidades de conservación"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
                    ...
                    <Table>
                        <TableHead style={{ backgroundColor: "#f0f0f0" }}>
                            <TableRow style={{ borderRadius: "10px 10px 0 0" }}>
                                ...
                                <TableCell align="center"><strong>UNIDAD DE CONSERVACIÓN</strong></TableCell>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getUnit(); setOpenModal(false);}} title={title}>
                <UnitModal onSuccess={()=>{ getUnit(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
