...
import LoansModal from "../modals/parametrizacion/LoansModal";
...
const LoansPage = () => {
    ...
    const [title, setTitle] = useState("Agregar nueva clase de préstamo");
    ...
    const getLoans = () => {
        ...
        fetch(`${BACKEND_URL}Administracion/TipoPrestamoObtener`, {
            method: 'POST',
            headers: {
    ...
    const handleEdit = (rowData) => {
        setTitle("Editar clase de préstamo");
    ...
    const openModals = () => {
        setTitle("Agregar nueva clase de préstamo");
        setSelectedRow([]);
        setOpenModal(true);
      };
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Clases de préstamos"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
                    ...
                    <Table>
                        <TableHead style={{ backgroundColor: "#f0f0f0" }}>
                            <TableRow style={{ borderRadius: "10px 10px 0 0" }}>
                                ...
                                <TableCell align="center"><strong>CLASE DE PRÉSTAMO</strong></TableCell>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getLoans(); setOpenModal(false);}} title={title}>
                <LoansModal onSuccess={()=>{ getLoans(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
