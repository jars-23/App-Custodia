...
import RolModal from "../modals/parametrizacion/RolModal";
...
const RolPage = () => {
    ...
    const [title, setTitle] = useState("Agregar nuevo rol");
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Roles"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getRol(); setOpenModal(false);}} title={title}>
                <RolModal onSuccess={()=>{ getRol(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
