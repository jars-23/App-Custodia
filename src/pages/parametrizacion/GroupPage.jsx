...
const GroupPage = () => {
    ...
    const getGroup = () => {
        ...
        fetch(`${BACKEND_URL}Administracion/GruposObtener`, {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Grupos"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getGroup(); setOpenModal(false);}} title={title}>
                <GroupModal onSuccess={()=>{ getGroup(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
            {/* Modal de agregar miembros */}
            <CustomModal open={openModalMembers} onClose={() => { getGroup(); setOpenModalMembers(false);}} title={titleMembers}>
                <UserGroupModal onSuccess={()=>{ getGroup(); setOpenModalMembers(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
