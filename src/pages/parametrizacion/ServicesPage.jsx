...
import ServicesModal from "../modals/parametrizacion/ServicesModal";
...
const ServicesPage = () => {
    ...
    const [title, setTitle] = useState("Agregar nuevo servicio");
    ...
    const getServices = () => {
        ...
        fetch(`${BACKEND_URL}Administracion/ServiciosObtener`, {
            method: 'POST',
            headers: {
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Servicios"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
                    ...
                    <Table>
                        <TableHead style={{ backgroundColor: "#f0f0f0" }}>
                            <TableRow style={{ borderRadius: "10px 10px 0 0" }}>
                                ...
                                <TableCell align="center"><strong>SERVICIO</strong></TableCell>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getServices(); setOpenModal(false);}} title={title}>
                <ServicesModal onSuccess={()=>{ getServices(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
