...
import ProductsModal from "../modals/parametrizacion/ProductsModal";
...
const ProductsPage = () => {
    ...
    const [title, setTitle] = useState("Agregar nueva clase de producto");
    ...
    const getProducts = () => {
        ...
        fetch(`${BACKEND_URL}Administracion/TipoProductoObtener`, {
            method: 'POST',
            headers: {
    ...
    const handleEdit = (rowData) => {
        setTitle("Editar clase de producto");
    ...
    const openModals = () => {
        setTitle("Agregar nueva clase de producto");
        setSelectedRow([]);
        setOpenModal(true);
      };
    ...
    return (
        ...
        <>
            ...
            {/* Titulo de la page */}
            <TitleComponent firstTitle={"Parametrización"} secondTitle={"Clases de productos"} btnTitle="Agregar" onBtnClick={() => openModals()}></TitleComponent>
                    ...
                    <Table>
                        <TableHead style={{ backgroundColor: "#f0f0f0" }}>
                            <TableRow style={{ borderRadius: "10px 10px 0 0" }}>
                                ...
                                <TableCell align="center"><strong>CLASE DE PRODUCTO</strong></TableCell>
            ...
            {/* Modal de creación */}
            <CustomModal open={openModal} onClose={() => { getProducts(); setOpenModal(false);}} title={title}>
                <ProductsModal onSuccess={()=>{ getProducts(); setOpenModal(false)}} data={selectedRow}/>
            </CustomModal>
        </>
    );
};
