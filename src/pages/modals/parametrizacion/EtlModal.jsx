...
const EtlModal = ({ onSuccess, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            var message = formData.id > 0 ? "¡La clase de ETL ha sido editada de forma correcta!" : "¡La clase de ETL se ha registrado de forma correcta!";
            ...
            const response = await fetch(`${BACKEND_URL}Administracion/AgregarEditarTipoETL`, {
                method: "POST",
                ...
                <fieldset disabled={loading}>
                    <div className="container pt-5">
                        ...
                        <div className="col-12 col-sm-6 col-md-8">
                                <TextField fullWidth label="Nombre de la ETL" value={formData.nombre || ""} name="nombre" required onChange={handleChange} />
                            </div>
                            <div className="col-12 col-sm-6 col-md-4">
