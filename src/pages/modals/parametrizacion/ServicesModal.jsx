...
import {
    Button, CircularProgress, TextField, FormControlLabel, Switch
} from "@mui/material";
import { useAlert } from "../../../components/Alert/AlertContext";

const ServicesModal = ({ onSuccess, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            var message = formData.id > 0 ? "¡El servicio ha sido editado de forma correcta!" : "¡El servicio se ha registrado de forma correcta!";
            ...
            const response = await fetch(`${BACKEND_URL}Administracion/AgregarEditarServicios`, {
                method: "POST",
                ...
                <fieldset disabled={loading}>
                    <div className="container pt-5">
                        ...
                        <div className="col-12 col-sm-6 col-md-8">
                                <TextField fullWidth label="Nombre del servicio" value={formData.nombre || ""} name="nombre" required onChange={handleChange} />
                            </div>
                            <div className="col-12 col-sm-6 col-md-4">
