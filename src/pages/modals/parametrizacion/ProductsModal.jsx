...
const ProductsModal = ({ onSuccess, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            var message = formData.id > 0 ? "¡La clase de producto ha sido editada de forma correcta!" : "¡La clase de producto se ha registrado de forma correcta!";
            ...
            const response = await fetch(`${BACKEND_URL}Administracion/AgregarEditarTipoProducto`, {
                method: "POST",
                ...
                <fieldset disabled={loading}>
                    <div className="container pt-5">
                        ...
                        <div className="col-12 col-sm-6 col-md-8">
                                <TextField fullWidth label="Nombre del producto" value={formData.nombre || ""} name="nombre" required onChange={handleChange} />
                            </div>
                            <div className="col-12 col-sm-6 col-md-4">
