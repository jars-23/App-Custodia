...
const LoansModal = ({ onSuccess, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            var message = formData.id > 0 ? "¡La clase de préstamo ha sido editada de forma correcta!" : "¡La clase de préstamo se ha registrado de forma correcta!";
            ...
            const response = await fetch(`${BACKEND_URL}Administracion/AgregarEditarTipoPrestamo`, {
                method: "POST",
                ...
                <fieldset disabled={loading}>
                    <div className="container pt-5">
                        ...
                        <div className="col-12 col-sm-6 col-md-8">
                                <TextField fullWidth label="Nombre del prestamo" value={formData.nombre || ""} name="nombre" required onChange={handleChange} />
                            </div>
                            <div className="col-12 col-sm-6 col-md-4">
